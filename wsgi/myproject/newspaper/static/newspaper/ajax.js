...
function checkUpdateCredentials( response )
{
    ...
    if ( response.success == 'both' )
    {
		...
		else if ( response.success == 'nameonly' )
		{
				...
				// build success message
				var newLine    = "\r\n"
				var successMSG = 'SUCCESS : your name have been updated!';
						successMSG = successMSG + newLine ;
						successMSG = successMSG + 'Full Name : ' + name ;
		...
		else if ( response.success == 'telephoneonly' )
		{
				...
				// build success message
				var newLine    = "\r\n"
				var successMSG = 'SUCCESS : your telephone number have been updated!';
						successMSG = successMSG + newLine ;
						successMSG = successMSG + 'Telephone : ' + num ;
...
// helper method which gets the username of whoever is logged in
